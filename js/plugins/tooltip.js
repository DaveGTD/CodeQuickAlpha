...
(function($) {
	...
	DarkTooltip.prototype = {
        ...
        case 'east':
					...
					break;
        case 'warning':
          leftPos += this.bearer.outerWidth() - this.tooltip.outerWidth();
          topPos += -this.tooltip.outerHeight() - this.tip.outerHeight()/2 - 8;
					break;
			}
		...
		setEvents: function(){
			...
			}else if(this.options.trigger == "external"){
        dt.setPositions();
        dt.toggle();
      }
		},
